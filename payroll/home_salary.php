          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
                ...
                <p class="pull-right">Overtime rate per hour: <big><b><?php  $query  = mysqli_query($con,"SELECT * from overtime");
                          while($row=mysqli_fetch_array($query))
                          {
                            $rate   = $row['rate'];
                          }
                          echo $rate; ?>.00</b></big></p><br>
                <p class="pull-right">Salary rate: <big><b><?php $query = mysqli_query($con,"SELECT * from salary");
                          while($row=mysqli_fetch_array($query))
                          {
                            $salary   = $row['salary_rate'];
                          }
 echo $salary; ?>.00</b></big></p>
