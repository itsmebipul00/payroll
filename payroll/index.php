...
$con = mysqli_connect("localhost","root","","payroll");
 ...
 die();
  ...
  $query  = mysqli_query($con,"SELECT * from deductions");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#instructor" role="button">Presented by: SLAGHYA SUMAN AND SHIVANGI</a></p>
      </div>

      <!-- Site footer -->
      <footer class="footer">
        <p align="center">presented by<a target="_blank" href="http://code-projects.org/">1CR18IS150 1CR18IS156 1CR18IS138</a></p>
      </footer>
